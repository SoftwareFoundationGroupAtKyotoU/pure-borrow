{- |
This module provides __unsafe__ internals of "Control.Monad.Borrow.Affine".
These are not meant to be used by end-users, so generally YOU SHOULD NOT import this module, and import "Control.Monad.Borrow.Affine" instead.
...
-}
module Control.Monad.Borrow.Affine.Unsafe (
  -- * Affine Modality
  unsafeAff,
) where
