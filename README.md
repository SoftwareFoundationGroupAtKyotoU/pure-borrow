...
4. Performance:
   + "Neither of our parallel quicksort implementations outperforms the baseline introsort in terms of runtime or memory allocation." (§4.2)
...
The core Pure Borrow API is all located under the `src` directory, establishing Implementation Claim (1). Here we list important modules:
...
This establishes Claim (2) about applicability to pure parallelism.
