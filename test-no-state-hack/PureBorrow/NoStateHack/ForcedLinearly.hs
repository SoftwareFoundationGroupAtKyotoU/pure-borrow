...
This module is a copy of @Control.Monad.Borrow.Pure.Lifetime.TokenSpec.Forced@ in the main test suite, built here with @-fno-state-hack@.
-}
module PureBorrow.NoStateHack.ForcedLinearly (
  twoRefs,
  twoRefsUnforced,
  callTwiceRef,
  callTwiceVector,
