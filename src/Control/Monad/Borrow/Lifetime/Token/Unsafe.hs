...
{- |
This module provides __unsafe__ internals of "Control.Monad.Borrow.Lifetime.Token".
These are not meant to be used by end-users, so generally YOU SHOULD NOT import this module, and import "Control.Monad.Borrow.Lifetime.Token" instead.
...
-}
module Control.Monad.Borrow.Lifetime.Token.Unsafe (
  Linearly (..),
  LinearOnly (..),
  LinearOnlyWitness (..),
  Now (..),
