...
This module is a copy of @Control.Monad.Borrow.Pure.Lifetime.TokenSpec.ClosedRun@ in the main test suite, built here with @-fno-state-hack@.
-}
module PureBorrow.NoStateHack.ClosedRun (
  twoMkRef,
  twoMkRefAfter,
  twoMkRefInline,
  twoMkVector,
